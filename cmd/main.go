...
import (
	...
	"github.com/nineinfra/hdfs-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(hdfsv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "31540875.nineinfra.tech",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&hdfsv1.HdfsCluster{}).SetupWebhookWithManager(mgr); err != nil {
